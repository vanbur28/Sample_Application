            ...
            steps {
                    withEnv([
                        ...
                        script {
                            ...
                            dockerImage = docker.build("063208468694.dkr.ecr.us-west-1.amazonaws.com"+"/${IMAGE_NAME}"+':${BUILD_VERSION}')
                            ...
                            docker.withRegistry("https://063208468694.dkr.ecr.us-west-1.amazonaws.com", "ecr:us-west-1:0cdb4404-ed40-459b-8589-7f1f235747ba") {
                                //docker.image("${env.IMAGE_NAME}").push("${BUILD_VERSION}")
                                sh 'docker push 063208468694.dkr.ecr.us-west-1.amazonaws.com/${IMAGE_NAME}:${BUILD_VERSION}'
                    }
        ...
        stage('Deploy to node') {
            ...
            steps {
                ...
                script {
                    ...
                    sh 'docker run -d -p 127.0.0.1:3600:80 --name vanburen_container 063208468694.dkr.ecr.us-west-1.amazonaws.com/${IMAGE_NAME}:${BUILD_VERSION}'
                }
            }
        }
    }
